...
typedef enum
{
    ...
    ERROR_ADDRESS            = -102,
    ERROR_ARG                = -103,
    ERROR_ILLEGAL_CMD        = -104,
    ERROR_STATE              = -105,
    ERROR_ERASE_PARAM        = -106,
    ERROR_CARD_LOCKED        = -107,
    ERROR_CARD_CONTROLLER    = -108,
    ERROR_WP_VIOLATION       = -109,
    ERROR_CARD_ECC           = -110,
    ERROR_UNKNOWN            = -111, // Resp2->error
    ERROR_OUT_OF_RANGE       = -112,
    ERROR_WP_ERASE_SKIP      = -113,
    ERROR_RESET              = -114,
    ERROR_MASK_VHC           = -115,
    ERROR_VOLTAGE_UNSUPPORTED= -116,
    ERROR_SENT_DATA          = -117,
    ERROR_SEQ_AKE            = -118,
    ERROR_APP_CMD            = -119,
    ERROR_CSD_OVERWRITE      = -120,
    ERROR_CARD_ECC_FAILED    = -121,
    ERROR_LOCK_UNLOCK        = -122,
    ERROR_ERASE_SEQ          = -123,
    ERROR_BLOCK_LEN          = -124,
    ERROR_SENT_CMD           = -125,
    ERROR_SD_BUSY_TIMEOUT    = -126,
    ERROR_RESPONCE           = -127,
    ERROR_TXUNDER            = -128,
    ERROR_DATA_CRC           = -129,
    ERROR_STOP_TRANSMISSION  = -130,
    ERROR_START_BIT          = -131,
    ERROR_RXOVERR            = -132,
    ERROR_WAIT_TIME          = -133,
} SD_ErrorCode;
